...
def learn_model(opt: Optional[List[str]]) -> None:
    ...
    parser.add_argument('--data_type', default='birds', choices=['birds', 'cars','chest'])
    ...
    if device.type == 'cuda':
        ...
        kwargs.update({'num_workers': 8, 'pin_memory': True})
    ...
    if args.data_type == 'chest':
        train_dataset = datasets.ImageFolder(
            args.data_train,
#            '../data_chest_protopool/l/data_chest_protopool/train_cropped_augmented/',
